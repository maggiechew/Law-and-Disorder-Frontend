...
export default function SimpleBackdrop() {
  ...
  return (
    <div>
      <Backdrop
        sx={{ backdropFilter:"blur(20px)", zIndex: (theme) => theme.zIndex.drawer + 1 }}
      ...
      >
        ...
        <Card sx={{ minWidth: 275 }} variant="outlined">
          <CardContent>
            ...
            <FormControl>
              <FormLabel id="demo-radio-buttons-group-label">Please choose your user type to continue:</FormLabel>
              <RadioGroup
